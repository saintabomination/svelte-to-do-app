...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-7mx1q4");
    ...
    // (11:4) <Button on:click={() => deleteTodo(todo.id)}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(11:4) <Button on:click={() => deleteTodo(todo.id)}>",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "svelte-9p0an7");
    			add_location(p, file$3, 9, 4, 135);
    			attr_dev(li, "class", "svelte-9p0an7");
    			add_location(li, file$3, 8, 2, 126);
    			attr_dev(div, "class", "todo svelte-9p0an7");
    			add_location(div, file$3, 7, 0, 105);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['todo', 'deleteTodo'];
    	...
    	$$self.$capture_state = () => ({ Button, todo, deleteTodo });
    	...
    	return [todo, deleteTodo, click_handler];
    }

    class Todo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { todo: 0, deleteTodo: 1 });
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 16, 6, 316);
    			attr_dev(div, "class", "no-todos svelte-1gxxjkg");
    			add_location(div, file$2, 15, 4, 287);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$2, 9, 4, 151);
    		},
    		m: function mount(target, anchor) {
    ...
    // (11:6) {#each todos as todo (todo.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*deleteTodo*/ 2) todo_changes.deleteTodo = /*deleteTodo*/ ctx[1];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(11:6) {#each todos as todo (todo.id)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 7, 0, 102);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let { todos } = $$props;
    	let { deleteTodo } = $$props;
    	const writable_props = ['todos', 'deleteTodo'];
    	...
    	$$self.$capture_state = () => ({ Todo, todos, deleteTodo });
    ...
    class TodoList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { todos: 0, deleteTodo: 1 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-1rfhj2z");
    			add_location(input, file$1, 15, 2, 269);
    			attr_dev(form, "class", "svelte-1rfhj2z");
    			add_location(form, file$1, 14, 0, 212);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Button, addTodo, todoText, handleSubmit });
    	...
    	return [todoText, handleSubmit, addTodo, input_input_handler, submit_handler];
    }
